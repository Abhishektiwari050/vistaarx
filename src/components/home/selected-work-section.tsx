        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b-2 border-black/10 pb-8">
          <div className="space-y-4 max-w-2xl">
            ...
            <p className="font-sans text-sm sm:text-base text-zinc-600 leading-relaxed">
              Every project is an editorial breakdown: The Problem → The System → The Build → The Result. Inspect live deployments and open source code below.
            </p>
          </div>
          ...
          {FEATURED_PROJECTS.map((project, idx) => (
            ...
            >
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 border-b-2 border-black/10 pb-4">
                ...
                <div className="flex items-center gap-3">
                  <span className="font-mono text-[9px] font-bold px-2 py-0.5 rounded bg-emerald-100 text-emerald-800 border border-emerald-300 uppercase">
                    ● {project.status}
                  </span>
                </div>
              </div>
