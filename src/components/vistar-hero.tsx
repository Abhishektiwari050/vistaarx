    ...
    <section className="relative min-h-[90vh] flex flex-col justify-between pt-32 pb-16 px-6 sm:px-12 md:px-16 overflow-hidden">
      ...
      <div className="max-w-6xl w-full mx-auto relative z-10 space-y-12 my-auto">
        ...
        <div className="flex items-center gap-3">
          <div className="inline-flex items-center gap-2 border-2 border-black bg-white px-3.5 py-1.5 rounded-lg text-[9px] font-mono font-black tracking-[2px] uppercase text-black shadow-[3px_3px_0px_#d8ff42]">
            <span className="w-2 h-2 rounded-full bg-[#ff1e90] animate-pulse" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            <h1 className="font-display font-black text-5xl sm:text-7xl lg:text-[5.5rem] uppercase tracking-tighter text-[#0a0a0a] leading-[0.92]">
              <SplitText text="We build the" direction="down" delay={0.05} />
              <br />
              <span className="text-black bg-[#d8ff42] px-2 py-0.5 border-2 border-black shadow-[4px_4px_0px_#000] inline-block my-1">
                systems
              </span>
              <br />
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <Link
                ...
                className="bg-[#d8ff42] text-black font-mono font-black text-xs tracking-widest uppercase px-8 py-5 rounded-xl border-[2.5px] border-black shadow-[4px_4px_0px_#000] hover:shadow-[6px_6px_0px_#ff1e90] hover:-translate-x-0.5 hover:-translate-y-0.5 active:translate-x-0.5 active:translate-y-0.5 transition-all interactive"
              >
                START A BUILD →
              </Link>
              <Link
                href="/work"
                onClick={() => playTickSound()}
                className="bg-white text-black font-mono font-black text-xs tracking-widest uppercase px-8 py-5 rounded-xl border-[2.5px] border-black shadow-[4px_4px_0px_#000] hover:bg-[#faf9f5] hover:shadow-[6px_6px_0px_#000] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all interactive"
              >
                EXPLORE OUR WORK →
              </Link>
            </div>
