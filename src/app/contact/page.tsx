...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] w-full relative flex flex-col justify-center px-6 md:px-12 pt-12 pb-16 z-20 max-w-7xl mx-auto space-y-12">
      ...
      {/* Header section */}
      <div className="mb-2 mt-8 relative z-10 text-left select-none space-y-4">
        ...
        <p className="font-sans text-xs sm:text-sm text-zinc-500 mt-4 max-w-md leading-relaxed">
          Transmit your project coordinates below. Our system operator will respond within less than 24 hours.
        </p>
      </div>

      <div className="w-full my-auto z-10 max-w-3xl mx-auto">
        <AnimatePresence mode="wait">
          {!isSubmitted ? (
            <motion.form
              ...
              className="bg-white border border-zinc-200 rounded p-8 md:p-10 shadow-sm text-left space-y-6 brutalist-glow-pink"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-[#faf9f5] border border-zinc-200 rounded px-4 py-3 font-sans text-xs text-black focus:outline-none focus:border-zinc-800 transition-colors"
                  />
                </div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full bg-[#faf9f5] border border-zinc-200 rounded px-4 py-3 font-sans text-xs text-black focus:outline-none focus:border-zinc-800 transition-colors resize-none"
                />
              </div>
        ...
        {/* Direct Email Backup */}
        <div className="text-center mt-8 font-sans text-xs text-zinc-500 select-none">
